...
@ComponentScan("com.treexor")
@PropertySource("classpath:application.properties")
@EnableJpaRepositories("com.treexor.springmvc.repository")
public class AppConfig {
	...
	private static final String PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN = "com.treexor.springmvc.model";
